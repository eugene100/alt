...
locals {
  ...
  # eks_cluster_oidc      = trimprefix(aws_eks_cluster.eks_cluster.identity.0.oidc.0.issuer, "https://")
  eks_cluster_oidc    = "oidc.eks.us-east-1.amazonaws.com/id/AD52891FF4E42E1A43C654F52219F75A"
